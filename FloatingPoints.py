...
# 10 (for ex., 100, 10, 1, 1/10, 1/100, etc). Python stores values as binary
# numbers. That is base 2 (for example, 16, 8, 4, 2, 1, 1/2, 1/4 1/8, 1/16).
# It is not important to deeply understand binary numbers at this point except
# to understand how decimal numbers are influenced.

# Some decimal numbers work "well" in both base 10 and base 2 counting and
# these numbers are stored
# in a Python in a way that floats behave as we would expect.
# For example, .125 is 1/10+2/100+5/1000 in base 10 and is 0/2 + 0/4 + 1/8 in
# base 2.
# But most fractions and decimals cannot be accurately represented by floats.

# You may want to read more here about floats :
...
# Round the numbers does not work either, as the issue is not with a rounding
# problem and is actually
